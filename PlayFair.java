...
System.out.print("Enter plain input> ");    
...
this.printResults(output);  
 ...
 if (choice==2)
{
//prompts user for cipher text  
System.out.print("Enter cipher input> ");    
String output = parseString(sc);  
while(output.equals(""))  
output = parseString(sc); 
String decodedOutput = decode(output);  

//outputs the result 
  
this.printDecResults(decodedOutput);  
}
...
static void keyTable(String[][] printTable)  
{  
...
//method that prints encryption result  
private void printResults(String encipher)  
{  
System.out.print("Cipher output: ");  
//prints the encrypted message  
System.out.println(encipher);    
 
}  
//method that prints decryption result

private void printDecResults(String dec)  
{  
  
  
System.out.print("Plaintext output: ");   
